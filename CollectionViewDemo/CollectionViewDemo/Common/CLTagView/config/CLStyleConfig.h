...
@interface CLStyleConfig : NSObject

+ (instancetype)sharedConfig;

///tagView距离左右两边的间距
@property (assign, nonatomic) CGFloat tagViewHorizontalMargin;

///标签间的垂直间距
@property (assign, nonatomic) CGFloat tagVerticalSpace;
///标签间的水平间距
@property (assign, nonatomic) CGFloat tagHorizontalSpace;



#pragma mark - SetSize
@property (assign, nonatomic) NSInteger sectionTitleFontSize;
...
@property (assign, nonatomic) NSInteger tagTextFontSize;
...
/// 标签默认文本颜色
@property (strong, nonatomic)UIColor* tagDefaultTextColor;
/// 标签选中状态下文本颜色
@property (strong, nonatomic)UIColor* tagSelectedTextColor;
/// 标签默认border颜色
@property (strong, nonatomic)UIColor* tagDefaultBorderColor;
///标签选中状态下border颜色
@property (strong, nonatomic)UIColor* tagSelectedBorderColor;
///标签默认背景颜色
@property (strong, nonatomic)UIColor* tagDefaultBackgroundColor;
///标签选中状态下背景颜色
@property (strong, nonatomic)UIColor* tagSelectedBackgroundColor;

///分组标题颜色
@property (strong, nonatomic)UIColor* sectionTitleColor;
